...
export class AzurePointsMaterial extends THREE.ShaderMaterial {
  constructor() {
    super({
      vertexShader: /* glsl */ `
      ...
      // Azure blue color
      vec3 azureBlue = vec3(0.0, 0.482, 1.0); // #007BFF
      ...
      void main() {
        ...
        // Mix azure blue with white based on sparkle brightness
        vec3 finalColor = mix(azureBlue, vec3(1.0), sparkleBrightness * 0.3);
